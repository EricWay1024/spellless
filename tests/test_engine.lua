...
do
  ...
  H.ok(flags:find("absorb plain typing", 1, true)
       and flags:find("word-backspace OFF", 1, true),
       "the caret inside a word means plain typing, and Backspace is Backspace: "
       .. flags)
